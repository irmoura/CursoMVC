...
namespace CursoMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "Id", "Descricao");//YD
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Quantidade,CategoriaId")] Produto produto)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "Id", "Descricao", produto.CategoriaId);//YD
            return View(produto);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Quantidade,CategoriaId")] Produto produto)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "Id", "Descricao", produto.CategoriaId);//Descricao
            return View(produto);
        }
